...
//    raylib::rlb_Font fontBm("resources/pixantiqua.fnt");
//
//    // TTF font : Font data and atlas are generated directly from TTF
//    // NOTE: We define a font base size of 32 pixels tall and up-to 250 characters
//    raylib::rlb_Font fontTtf("resources/pixantiqua.ttf", 32, 0, 250);
//
//    bool useTtf = false;
//
...
//            if (!useTtf)
//            {
//                fontBm.DrawText(msg, rlb_Vector2{ 20.0f, 100.0f }, fontBm.baseSize, 2, MAROON);
//                raylib::DrawText("Using BMFont (Angelcode) imported", 20, GetScreenHeight() - 30, 20, GRAY);
//            }
//            else
//            {
//                fontTtf.DrawText(msg, rlb_Vector2{ 20.0f, 100.0f }, fontTtf.baseSize, 2, LIME);
