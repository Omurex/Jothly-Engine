...
//    raylib::rlb_Font font1("resources/custom_mecha.png");          // Font loading
//    raylib::rlb_Font font2("resources/custom_alagard.png");        // Font loading
//    raylib::rlb_Font font3("resources/custom_jupiter_crash.png");  // Font loading
//
//    raylib::rlb_Vector2 fontPosition1(screenWidth/2 - MeasureTextEx(font1, msg1.c_str(), font1.baseSize, -3).x/2,
//                              screenHeight/2 - font1.baseSize/2 - 80);
//
//    raylib::rlb_Vector2 fontPosition2(screenWidth/2 - MeasureTextEx(font2, msg2.c_str(), font2.baseSize, -2).x/2,
//                              screenHeight/2 - font2.baseSize/2 - 10);
//
//    raylib::rlb_Vector2 fontPosition3(screenWidth/2 - MeasureTextEx(font3, msg3.c_str(), font3.baseSize, 2).x/2,
