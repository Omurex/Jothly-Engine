...
//    raylib::rlb_Texture texture("resources/raylib_logo.png");
//    raylib::rlb_Color textColor = raylib::rlb_Color::LightGray();
//
//    // Main game loop
...
//        BeginDrawing();
//        {
//            window.ClearBackground(raylib::rlb_Color::RayWhite());
//
