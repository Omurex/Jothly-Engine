...
//    raylib::rlb_RenderTexture2D target(gameScreenWidth, gameScreenHeight);
//    target.GetTexture().SetFilter(TEXTURE_FILTER_BILINEAR); // Texture scale filter to use
//
//    raylib::rlb_Color colors[10] = { 0 };
//    for (int i = 0; i < 10; i++) {
//        colors[i] = raylib::rlb_Color((unsigned char)GetRandomValue(100, 250), (unsigned char)GetRandomValue(50, 150), (unsigned char)GetRandomValue(10, 100), 255);
//    }
//
...
//        raylib::rlb_Vector2 mouse = raylib::Mouse::GetPosition();
//        raylib::rlb_Vector2 virtualMouse(
//            (mouse.x - (GetScreenWidth() - (gameScreenWidth*scale))*0.5f)/scale,
//            (mouse.y - (GetScreenHeight() - (gameScreenHeight*scale))*0.5f)/scale
//        );
//        virtualMouse = virtualMouse.Clamp(raylib::rlb_Vector2::Zero(), raylib::rlb_Vector2(gameScreenWidth, gameScreenHeight));
//
...
//            target.GetTexture().Draw(raylib::rlb_Rectangle(0.0f, 0.0f, target.texture.width, -target.texture.height),
//                raylib::rlb_Rectangle(
...
//                ),
//                raylib::rlb_Vector2::Zero(), 0.0f, WHITE);
//        EndDrawing();
//        //--------------------------------------------------------------------------------------
//    }
//
