...
//
//    // Box A: Moving box
//    raylib::rlb_Rectangle boxA(10, GetScreenHeight()/2 - 50, 200, 100);
//    int boxASpeedX = 4;
//
//    // Box B: Mouse moved box
//    raylib::rlb_Rectangle boxB(GetScreenWidth()/2 - 30, GetScreenHeight()/2 - 30, 60, 60);
//
//    raylib::rlb_Rectangle boxCollision(0); // Collision rectangle
//
