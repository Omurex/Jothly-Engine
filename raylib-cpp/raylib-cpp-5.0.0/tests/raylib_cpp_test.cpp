...
//    // Vector
//    {
//        raylib::rlb_Vector2 position(50, 100);
...
//
//        raylib::rlb_Vector2 speed(10, 10);
//        position += speed;
//        AssertEqual(position.x, 310);
//        AssertEqual(raylib::Window::IsReady(), false);
//
//        raylib::rlb_Vector2 size{50,50};
//        raylib::rlb_Vector2 halfsize = size / 2.0f;
//
//        AssertEqual(size.x, 50);
//        AssertEqual(halfsize.x, 25);
//
//        raylib::rlb_Vector2 doublesize = size * 2.0f;
//        AssertEqual(size.x, 50);
...
//    // Color
//    {
//        raylib::rlb_Color color = RED;
//        AssertEqual(color.ToInt(), ::ColorToInt(RED));
//        color = RAYWHITE;
//        ::rlb_Color raylibColor = RAYWHITE;
//        AssertEqual(color.r, raylibColor.r);
//    }
//
//    // Math
//    {
//        raylib::rlb_Vector2 direction(50, 50);
//        raylib::rlb_Vector2 newDirection = direction.Rotate(30);
...
//    {
//        // Loading
//        raylib::rlb_Image image(path + "/resources/feynman.png");
...
//    // Wave
//    {
//        raylib::rlb_Wave wave(path + "/resources/weird.wav");
...
//        bool passed = false;
//        try {
//            raylib::rlb_Texture texture("notfound.png");
//        }
