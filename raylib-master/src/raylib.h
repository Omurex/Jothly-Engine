...
typedef rlb_Camera3D rlb_Camera;    // Camera type fallback, defaults to Camera3D
...
RLAPI rlb_Ray GetMouseRay(rlb_Vector2 mousePosition, rlb_Camera camera);      // Get a ray trace from mouse position
RLAPI rlb_Matrix GetCameraMatrix(rlb_Camera camera);                      // Get camera transform matrix (view matrix)
RLAPI rlb_Matrix GetCameraMatrix2D(rlb_Camera2D camera);                  // Get camera 2d transform matrix
RLAPI rlb_Vector2 GetWorldToScreen(rlb_Vector3 position, rlb_Camera camera);  // Get the screen space position for a 3d world space position
...
RLAPI rlb_Vector2 GetWorldToScreenEx(rlb_Vector3 position, rlb_Camera camera, int width, int height); // Get size position for a 3d world space position
...
//------------------------------------------------------------------------------------
RLAPI void UpdateCamera(rlb_Camera *camera, int mode);      // Update camera position for selected mode
RLAPI void UpdateCameraPro(rlb_Camera *camera, rlb_Vector3 movement, rlb_Vector3 rotation, float zoom); // Update camera movement/rotation
...
RLAPI void DrawBillboard(rlb_Camera camera, rlb_Texture2D texture, rlb_Vector3 position, float size, rlb_Color tint);   // Draw a billboard texture
RLAPI void DrawBillboardRec(rlb_Camera camera, rlb_Texture2D texture, rlb_Rectangle source, rlb_Vector3 position, rlb_Vector2 size, rlb_Color tint); // Draw a billboard texture defined by source
RLAPI void DrawBillboardPro(rlb_Camera camera, rlb_Texture2D texture, rlb_Rectangle source, rlb_Vector3 position, rlb_Vector3 up, rlb_Vector2 size, rlb_Vector2 origin, float rotation, rlb_Color tint); // Draw a billboard texture defined by source and rotation
