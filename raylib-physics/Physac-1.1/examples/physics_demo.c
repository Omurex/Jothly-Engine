...
//    PhysicsBody floor = CreatePhysicsBodyRectangle((rlb_Vector2){ screenWidth/2, screenHeight }, 500, 100, 10);
//    floor->enabled = false; // Disable body state to convert it to static (no dynamics, but collisions)
//
//    // Create obstacle circle physics body
//    PhysicsBody circle = CreatePhysicsBodyCircle((rlb_Vector2){ screenWidth/2, screenHeight/2 }, 45, 10);
...
//            }
//
//            DrawText("Left mouse button to create a polygon", 10, 10, 10, RLB_WHITE);
//            DrawText("Right mouse button to create a circle", 10, 25, 10, RLB_WHITE);
//
