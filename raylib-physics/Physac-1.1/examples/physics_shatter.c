...
//    CreatePhysicsBodyPolygon((rlb_Vector2){ screenWidth/2, screenHeight/2 }, GetRandomValue(80, 200), GetRandomValue(3, 8), 10);
//    
//    SetTargetFPS(60);
//    //--------------------------------------------------------------------------------------
//
...
//                    rlb_Vector2 vertexA = GetPhysicsShapeVertex(currentBody, j);
//
//                    int jj = (((j + 1) < vertexCount) ? (j + 1) : 0);   // Get next vertex or first to close the shape
//                    rlb_Vector2 vertexB = GetPhysicsShapeVertex(currentBody, jj);
//
//                    DrawLineV(vertexA, vertexB, RLB_GREEN);     // Draw a line between two vertex positions
//                }
//            }
//
//            DrawText("Left mouse button in polygon area to shatter body", 10, 10, 10, RLB_WHITE);
//
