...
namespace jothly
{
	class NavMesh : public Component
	{
		...
		std::vector<Vector2> CalculatePathWithoutSmoothing(Vector2 start, Vector2 end, bool removeFirst = false, bool removeLast = false);
		std::vector<Vector2> CalculatePathWithSmoothing(Vector2 start, Vector2 end, bool removeFirst = false, bool removeLast = false);
	};
}